    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
        	...
        	<div id="layoutSidenav_content">
                <main>
                <div class="card-header text-center" style="background-color: blue;color:white"> Formulaire des Clients </div>
        			<form class="container-fluid" action="Client" method="POST">
                  
                    <div class="form-group">
                        <label class="control-label" for="nom"> Nom de famille </label>
